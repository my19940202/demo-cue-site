...
`DemoCue` 是一个用于录制屏幕视频、产品演示、教程讲解和技术分享的桌面端 AI 悬浮提示条。
...
- 英文：`AI cue bar for screen recording`
- 中文：`录屏演示的 AI 悬浮提示条`
...
命名策略从纯描述词调整为“品牌词 + SEO 副标题”：`DemoCue` 负责品牌记忆，`AI cue bar for screen recording` 负责搜索相关性。
...
1. Header
   ...
   - 语言切换
   - GitHub Releases 下载 CTA

2. Hero
   - SEO 导向 eyebrow
   - 大标题
   - 一句话说明产品
   - 主 CTA：从 GitHub 下载 / Download from GitHub
   - 次 CTA：查看功能 / View features
   - 右侧视觉：真实产品截图轮播
...
6. Download
   - 指向 GitHub Releases
   - 说明从最新 release assets 下载对应系统安装包
   - 平台支持以 GitHub Releases 中实际构建产物为准
...
- 柔和阴影；
- 中间导航轻量；
- 右侧保留语言切换和 GitHub Releases 下载 CTA。
...
Hero 右侧使用真实产品截图轮播，不再使用 HTML/CSS 模拟的软件界面。

轮播内容来自 `public/posters`：
...
- `AI cue bar for screen recording`
...
1. 补真实安装说明
   - GitHub Releases 下载
   - Windows / macOS release assets 说明
   - 权限说明
   - 首次打开流程
